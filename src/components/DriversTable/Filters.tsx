		...
		<>
			<S.Filters>
				...
				<S.SelectGroup>
					...
					<FilterSelect placeholder="Условия работы:" defaultValue="Все">
						<MenuItem value="Все">Все</MenuItem>
						<MenuItem value="Остальные">Остальные</MenuItem>
					</FilterSelect>

					<FilterSelect placeholder="Агрегаторы:" defaultValue="Все">
						<MenuItem value="Все">Все</MenuItem>
						<MenuItem value="Остальные">Остальные</MenuItem>
					</FilterSelect>

					<FilterSelect placeholder="Роли:" defaultValue="Все">
						<MenuItem value="Все">Все</MenuItem>
						<MenuItem value="Остальные">Остальные</MenuItem>
					</FilterSelect>
				</S.SelectGroup>
